...
public class StaffDonHangController {
    ...
    // =============================
    // Endpoint 1 - Danh sách đơn hàng (STAFF)
    // GET /staff/orders
    // =============================
    @GetMapping("")
    public String danhSachDonHang(
        ...
        // Nhân viên thấy tất cả đơn hàng
        ...
        // STAFF dùng template staff/orders (màu xanh)
        return "staff/orders";
    }

    // =============================
    // Endpoint 2 - Chi tiết đơn hàng (STAFF)
    // GET /staff/orders/detail/{id}
    // =============================
    ...
    public String chiTietDonHang(@PathVariable Integer id, Authentication auth, Model model) {
        ...
        // STAFF dùng template staff/order_detail (màu xanh)
        return "staff/order_detail";
    }

    // =============================
    // Endpoint 3 - Cập nhật trạng thái đơn hàng (STAFF)
    // POST /staff/orders/update-status/{id}
    // =============================
    ...
    private boolean isValidTransition(String from, String to) {
        ...
        if ("Đang giao".equals(from) && "Đã hủy".equals(to)) return true;
        return false;
    }
}
